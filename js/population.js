...
function drawprogressbar() {
    ...
    let resultelement = document.querySelector('#results');
    resultelement.innerHTML = '<div class="progress col-md-8"><div class="progress-bar progress-bar-striped bg-danger" role="progressbar" style="width: 75%" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div></div>';
}
...
let calculate = () => {
    ...
    var nasobitel = 1
        ...
        createResults(riesenia.slice(0, 10))
        console.log('calculate end')
}

document.querySelector('body > div > div:nth-child(4) > div.mb-3 > a').addEventListener('click', calculate)